...
<procedure>
 <p> 
            <control>Instruction:</control> From a given Linux host, each student must 
            manage a share directory "/share/case_x" for a detective company by using the commands <shortcut>chown</shortcut>, 
            <shortcut>chmod</shortcut>, <shortcut>setfacl</shortcut>, and <shortcut>getfacl</shortcut> as the following criteria:
</p>
